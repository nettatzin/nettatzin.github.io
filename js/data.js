...
const STRATEGY = {
  ...
  caseStudies: [

    {
      ...
      description: [
        "Led end-to-end product strategy for an AI-powered compliance platform designed to evaluate expense submissions at scale across a global organization.",
...

    {
      ...
      description: [
        "Led product discovery for an AI-enhanced patient engagement and clinical transparency platform for Mego Afek's chronic pain rehabilitation device — translating a hardware-first product with limited digital intelligence into a data-driven, clinically connected patient journey.",
